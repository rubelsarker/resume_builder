            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('personal.create') }}">Information</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profileDropdown">
                                <a class="dropdown-item" href="{{ route('employment.index') }}">Employment</a>
                                <a class="dropdown-item" href="{{ route('education.index') }}">Education</a>
                                <a class="dropdown-item" href="{{ route('skill.index') }}">Skill</a>
                            </div>
                        </li>
                        <li class="nav-item">
